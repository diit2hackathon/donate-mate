			...
			<div class="wrapper">
				...
				<nav>
					<ul id="top_nav">
						...
						<li class="end" style="color:#FFF; font-size:12px"><a href="logout.jsp">Logout</a></li>                        
					</ul>
				</nav>
				<nav>
					<ul id="menu">
...
<!-- content -->
		<article id="content">
			...
			<div class="wrapper">
                ...
                <iframe src="DonationReportServlet" height="500" width="500"></iframe>
                <iframe src="DistributionReportServlet" height="500" width="420"></iframe>
