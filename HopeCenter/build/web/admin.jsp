		...
		<article id="content">
			...
			<div class="wrapper">
				<div class="pad_left2 relative">
					<h4 class="color3">Control Panel</h4>                                     
				</div>
                                <nav>
					<ul id="menu">
						<li><a href="Reports.jsp">Donation & Distribution Report</a></li>
                                                <li><a href="con_contributor.jsp">Contactble Contributors List</a></li>
						<li><a href="fund.jsp">Fund Balance</a></li>
